...
function listUserTodos(){if(null!==user_todos)for(var a=0;a<user_todos.length;a++){var b='<div id="col-sm-12" style="padding-bottom: 15px; padding-top:15px; text-shadow:0 1px 3px rgba(255, 255, 255, .5)"><li class="ui-state-default" style="color:black"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>Description: '+user_todos[a].description+" is_complete: "+user_todos[a].is_complete+'<button id="btn btn-sm btn-primary" style="margin-left: 15px" onClick="updateToDo('+user_todos[a].id+')">Update</button></li></div>';
$("#sortable").append(b)}}$(function(){$("#sortable").sortable();$("#sortable").disableSelection()});
