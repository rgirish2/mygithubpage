...
function listUserTodos(){if(null!==user_todos)for(var a=0;a<user_todos.length;a++){var b='<div id="col-sm-12" style="padding-bottom: 15px; padding-top:15px"><li class="ui-state-default" style="color:black"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>Description: '+user_todos[a].description+" Id: "+user_todos[a].id+" is_complete: "+user_todos[a].is_complete+'<button id="btn btn-sm btn-primary" onClick="updateToDo('+user_todos[a].id+')">Update</button>></li></div>';$("#sortable").append(b)}}
